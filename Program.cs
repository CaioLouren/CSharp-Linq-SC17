...
namespace Secao
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>() { new Product() { Id = 1, Name = "Computer", Price = 1100.0, Category = c2 },
            ...
            var r3 = products.Where(p => p.Name[0] == 'C').Select(p => new { p.Name, p.Price, CategoryName = p.Category.Name }); //tive q por um apelido, pois iria repetir o name duas vezes
            ...
            Console.WriteLine("First or default test2: " + r7);// vai dar uma exeção, pode usar o FirstOrDefault, pq se ele n encontrar ngm, ele retorna null
